...
SAMPLE_CHUNKS = [
    {
        "content": (
            ...
            " documents from a knowledge base and uses them as context for a"
            " language model to generate accurate, grounded responses."
        ),
    ...
    },
    {
        "content": (
            ...
            " enabling semantic search. Models like Voyage AI produce"
    ...
    },
    {
        "content": (
            ...
            " similarity search. It supports multiple index types including"
            " HNSW and IVFFlat, and distance metrics like cosine similarity,"
            " inner product, and L2 distance."
        ),
    ...
    },
    {
        "content": (
            ...
            " chunks with overlap, sentence-based splitting, and recursive"
            " character splitting. Typical chunk sizes are 256-512 tokens."
        ),
        "metadata": {"topic": "chunking", "chunk_index": 0},
    },
    {
        "content": (
            "Hybrid search combines vector (semantic) search with keyword"
            " (lexical) search. This approach captures both semantic meaning"
            " and exact keyword matches. Results from both methods can be"
    ...
    {
        "content": (
            "Reranking is a second-stage retrieval step that re-scores"
            " retrieved documents using a more powerful model. After initial"
            " retrieval returns candidate documents, a reranker evaluates each"
            " document's relevance to the query more carefully."
        ),
    ...
    },
    {
        "content": (
            ...
            " PostgreSQL. It provides authentication, real-time subscriptions,"
            " storage, and database management. With the pgvector extension,"
            " Supabase can serve as a vector database for RAG applications."
        ),
